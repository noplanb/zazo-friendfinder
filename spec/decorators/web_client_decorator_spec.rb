...
describe WebClientDecorator do
  ...
  describe '#another_contacts' do
    let(:another_contact_1) { FactoryGirl.create :contact, owner: contact.owner, total_score: 4 }
    let(:another_contact_2) { FactoryGirl.create :contact, owner: contact.owner, total_score: 6 }
    let(:another_contact_3) { FactoryGirl.create :contact, owner: contact.owner, total_score: 5 }
    let(:another_contact_4) { FactoryGirl.create :contact, owner: contact.owner, total_score: 3 }
