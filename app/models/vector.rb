class Vector < ActiveRecord::Base
  ...
  ALLOWED_ADDITIONS = {
    mobile:   %w(sms_messages_sent marked_as_favorite users_with_contact),
    email:    %w(email_messages_sent marked_as_favorite users_with_contact),
    facebook: %w(users_with_contact)
